...
int main () {
    ...
    if (votosPositivos>votosNegativos && votosPositivos>=votosEnBlanco) { // el >= es necesario para que si empatan positivos y en blanco, gane positivos.
        cout << "El resultado del plebiscito fue a favor de la poda de arboles." << endl;
    } else if (votosNegativos>votosPositivos && votosNegativos>=votosEnBlanco) { // el >= es necesario para que si empatan negativos y en blanco, gane negativos.
        cout << "El resultado del plebiscito fue en contra de la poda de arboles." << endl;
    } else if ((votosEnBlanco>votosPositivos && votosEnBlanco>votosNegativos) || votosNegativos==votosPositivos) { // indeterminado en caso de empate SOLAMENTE entre positivos y negativos.
