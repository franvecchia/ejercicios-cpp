...
int main () {
    ...
    if (ingresoFecha) { // puede realizarse tambien con un contador y que diga > 0 o si diferenciaMarea es > 0 (si no es mayor a 0, significa que nunca calculo por lo tanto no hay datos).
